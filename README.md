...
### 2. Подтянуть изменения из ветки dev
...
### 4. Запуск проекта
⚠️ ВАЖНО! Если вы запускаетесь на Windows:
* Откройте entrypoint.sh в редакторе кода
* Внизу справа поменяйте формат CRLF
* Выберите LF
* Сохраните
